...
export const metadata: Metadata = {
  title: {
    default: 'Velour — Premium Intimacy Wellness',
    template: '%s | Velour',
  },
  description: 'Discover premium intimacy wellness products designed for pleasure, confidence, and self-care. Discreet shipping, luxurious quality.',
}
